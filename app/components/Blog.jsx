...
export default function BlogPage() {
  ...
  return (
    <div className="flex flex-col gap-10 mt-20 px-30 max-[1000px]:px-4 scroll-mt-[82px]" id="blog">
      <div className="flex items-center justify-between">
        <h1 className="font-Montserrat text-xl font-medium">
          My Blog
        </h1>
        <a href="/moreblog" className="bg-orange-500 py-3 px-6 text-white rounded-full">
          More Blog
        </a>
      </div>
