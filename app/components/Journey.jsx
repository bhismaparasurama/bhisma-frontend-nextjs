...
const Journey = () => {
  return (
    <div className="mt-20 px-30 scroll-mt-[100px] max-[1000px]:px-4" id="journey">
      <div>
      ...
      <div className="relative h-auto mt-10">
        <div className="flex flex-col gap-20">
          <div className="flex flex-row-reverse justify-between items-center max-[600px]:flex-col z-10">
            <div className="w-[40%] max-[600px]:w-full max-[600px]:flex max-[600px]:justify-end">
              <Image src={assets.number_1} alt="" className="w-full max-[600px]:w-52 max-[500px]:w-22" />
            </div>
            <div className="w-[40%] max-[600px]:w-full flex flex-col gap-4">
              <svg
                viewBox="0 0 128 128"
                className="w-40 p-4 border-2 border-orange-500 rounded-xl max-[500px]:w-22"
              >
                <path
                  fill="#E44D26"
              ...
              <h1 className="font-Montserrat font-bold text-8xl max-[1500px]:text-4xl max-[600px]:text-2xl">HTML</h1>
              <p className="font-Opensans text-2xl text-gray-600 max-[1500px]:text-xl max-[500px]:text-base">
                I learning HTML to understand the basic structure of web
                pages, then continued with CSS to style the appearance,
                mastering various layout techniques such as Flexbox and Grid,
                and implementing responsive design to ensure websites look good
                on all devices.
              </p>
            </div>
          </div>
          <div className="flex justify-between items-center max-[600px]:flex-col z-10">
            <div className="w-[40%] max-[600px]:w-full">
              <Image src={assets.number_2} alt="" className="w-full max-[600px]:w-52 max-[500px]:w-22" />
            </div>
            <div className="w-[40%] max-[600px]:w-full flex flex-col gap-4 max-[600px]:items-end">
              <svg
                viewBox="0 0 128 128"
                className="w-40 p-4 border-2 border-orange-500 rounded-xl max-[500px]:w-22"
              >
              ...
              <h1 className="font-Montserrat font-bold text-8xl max-[1500px]:text-4xl max-[600px]:text-2xl">Bootstrap</h1>
              <p className="font-Opensans text-2xl text-gray-600 max-[1500px]:text-xl max-[500px]:text-base max-[600px]:text-right">
                I started learning Bootstrap to speed up the process of building
                website interfaces, understanding the grid system that
                simplifies creating responsive layouts, and utilizing
                ready-to-use components such as navbars, cards, and modals to
                improve development efficiency.
              </p>
            </div>
          </div>
          <div className="flex justify-between items-center max-[600px]:flex-col z-10 flex-row-reverse">
            <div className="w-[40%] max-[600px]:w-full max-[600px]:flex max-[600px]:justify-end">
              <Image src={assets.number_3} alt="" className="w-full max-[600px]:w-52 max-[500px]:w-22" />
            </div>
            <div className="w-[40%] max-[600px]:w-full flex flex-col gap-4">
              <svg
                viewBox="0 0 128 128"
              ...
              <h1 className="font-Montserrat font-bold text-8xl max-[1500px]:text-4xl max-[600px]:text-2xl">SASS</h1>
              <p className="font-Opensans text-2xl text-gray-600 max-[1500px]:text-xl max-[500px]:text-base">
                I learned Sass to write CSS more efficiently, utilizing features
                such as variables, nesting, and mixins, making it easier to
                manage code and speed up the styling development process.
              </p>
            </div>
          </div>
          <div className="flex justify-between items-center max-[600px]:flex-col z-10">
            <div className="w-[40%] max-[600px]:w-full">
              <Image src={assets.number_4} alt="" className="w-full max-[600px]:w-52 max-[500px]:w-22" />
            </div>
            <div className="w-[40%] max-[600px]:w-full flex flex-col gap-4 max-[600px]:items-end">
              <svg
                viewBox="0 0 128 128"
              ...
              <h1 className="font-Montserrat font-bold text-8xl max-[1500px]:text-4xl max-[600px]:text-2xl">Javascript</h1>
              <p className="font-Opensans text-2xl text-gray-600 max-[1500px]:text-xl max-[500px]:text-base max-[600px]:text-right">
                I learning JavaScript to add interactivity to websites,
                understanding basic concepts such as variables, functions, and
                event handling, as well as mastering DOM manipulation to make
                web pages more dynamic and responsive to users.
              </p>
            </div>
          </div>
          <div className="flex justify-between items-center max-[600px]:flex-col z-10 flex-row-reverse">
            <div className="w-[40%] max-[600px]:w-full max-[600px]:flex max-[600px]:justify-end">
              <Image src={assets.number_5} alt="" className="w-full max-[600px]:w-52 max-[500px]:w-22" />
            </div>
            <div className="w-[40%] max-[600px]:w-full flex flex-col gap-4">
              <svg
                viewBox="0 0 128 128"
              ...
              <h1 className="font-Montserrat font-bold text-8xl max-[1500px]:text-4xl max-[600px]:text-2xl">
                Tailwind CSS
              </h1>
              <p className="font max-[1500px]:text-xl max-[500px]:text-base Opensans text-2xl text-gray-600">
                I learned Tailwind CSS to speed up UI design using a
                utility-first approach, leveraging ready-to-use classes to
                control layout, colors, and typography, making the styling
          ...
          <div className="flex justify-between items-center max-[600px]:flex-col z-10">
            <div className="w-[40%] max-[600px]:w-full">
              <Image src={assets.number_6} alt="" className="w-full max-[600px]:w-52 max-[500px]:w-22" />
            </div>
            <div className="w-[40%] max-[600px]:w-full flex flex-col gap-4 max-[600px]:items-end">
              <svg
                viewBox="0 0 128 128"
              ...
              <h1 className="font-Montserrat font-bold text-8xl max-[1500px]:text-4xl max-[600px]:text-2xl">Next Js</h1>
              <p className="font-Opensans text-2xl text-gray-600 max-[1500px]:text-xl max-[500px]:text-base max-[600px]:text-right">
                I learning Next.js to build modern, high-performance web
                applications, understanding concepts such as server-side
                rendering (SSR), static site generation (SSG), and built-in
                routing, enabling me to create fast, SEO-friendly, and easily
                maintainable websites.
              </p>
            </div>
          </div>
        </div>
        <div className="absolute h-full bg-black w-[4px] rounded-full top-0 left-[50%] max-[600px]:hidden">
          {/* line */}
        </div>
      </div>
    </div>
